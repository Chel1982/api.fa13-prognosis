    ...
    public function handle()
    {
        ...
        foreach ($emails as $email) {
            ...
            if (mail(
                ...
                обсуждать матчи всех чемпионатов без цензуры(реализованы чаты на все турниры
                и общий чат), читать все пресс-конференции(время обновления с 4 утра до 22 вечера).
